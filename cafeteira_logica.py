# Importando o seu módulo de estoque
    ...
    if escolha == "1":
        ...
        while True:
            ...
            for cafe, qtd_total in itens_estoque.estoque.items():
                ...
                print(
                    f"- {cafe}: R$ {itens_estoque.precos[cafe]:.2f} ({qtd_disponivel} unid. disponíveis)")
            ...
            cafes_mapeados = {"1": "Cappuccino",
                              "2": "Latte", "3": "Espresso", "4": "Mocha"}
            ...
            if opcao in cafes_mapeados:
                ...
                if (itens_estoque.estoque[nome_cafe] - carrinho.count(nome_cafe)) > 0:
                    ...
                    print(
                        f"❌ Desculpe, o estoque de {nome_cafe} esgotou para este pedido!")
        ...
        if not carrinho:
            ...
            for cafe in set(carrinho):
                print(
                    f"• {cafe}: {carrinho.count(cafe)} unid. (R$ {itens_estoque.precos[cafe] * carrinho.count(cafe):.2f})")
            print(f"----------------------")
            ...
            if opcao_finalizar in ["sim", "s"]:
                ...
                print(
                    "🎉 Compra finalizada com sucesso! Seu café começará a ser preparado.")
                carrinho.clear()
                total_conta = 0.0
            else:
                print(
                    "🔄 Voltando ao menu principal. Seus itens continuam salvos no carrinho.")
